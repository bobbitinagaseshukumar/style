...
router.get('/admin/pending-count', authorize('ADMIN', 'SUPER_ADMIN'), orderController.adminGetPendingCount);
...
router.post('/admin/:id/cancel', authorize('ADMIN', 'SUPER_ADMIN'), orderController.adminCancelOrder);
router.put('/admin/:id/cancel', authorize('ADMIN', 'SUPER_ADMIN'), orderController.adminCancelOrder);
