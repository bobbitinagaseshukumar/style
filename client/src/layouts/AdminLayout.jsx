    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden font-sans">
      ...
      {mobileSidebar && (
        <div className="fixed inset-0 z-[9999] lg:hidden">
          ...
          {/* Drawer Panel */}
          <aside className="fixed inset-y-0 left-0 w-[290px] bg-[#0D0D12] text-white shadow-2xl flex flex-col border-r border-white/10 z-[10000] overflow-hidden">
            <div className="h-16 flex items-center justify-between px-4 border-b border-white/10 shrink-0 bg-[#0A0A0E]">
              <Link
                to="/"
                onClick={closeMobileDrawer}
                title="Go to Storefront Homepage"
                className="flex items-center gap-3 active:opacity-75 transition cursor-pointer"
              >
              ...
              <button
                type="button"
                onClick={closeMobileDrawer}
                className="text-gray-400 active:text-amber-400 p-2 rounded-xl active:bg-white/10 transition cursor-pointer"
                  ...
                  {group.links.map((link) => {
                    ...
                    return (
                      <Link
                        ...
                        className={`w-full flex items-center gap-3 px-3.5 py-3 rounded-xl transition-all duration-150 text-left cursor-pointer active:scale-[0.98] ${
                          isActive
                            ? 'bg-gradient-to-r from-amber-500/20 to-amber-500/5 text-amber-400 border border-amber-500/30 font-bold'
                            : 'text-gray-300 active:bg-white/10 active:text-white font-medium'
                        }`}
                      >
